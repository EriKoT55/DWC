...
tipo = new Map(["numeroRegistro", new Map(["ACD123",true]), (["AC123",false]),(["ACGTHT123",false]),(["145265",false]),(["ACG124w",false])]);
...
tipo = new Map(["nombre", new Map(["Fernández J.",true]),(["López Ariadna M.",false]),(["Castillo JL.",true]),(["Castillo JSL.",false]),(["López M",false]),(["Martinez",false]),(["J.",false])]);
...
tipo = new Map(["numeroSS", new Map(["010125789",true]),(["a14568892",false]),(["010125789",false]),(["010125789",false])]);
/*tipo = new Map(["numeroSS", new Map(["a14568892",false])]);
tipo = new Map(["numeroSS", new Map(["010125789",false])]);
tipo = new Map(["numeroSS", new Map(["010125789",false])]);*/

//COMPROBACION direccion TERMINAR DE PEGAR
tipo = new Map(["direccion", new Map(["C/Federico lorca, 50",true]),(["Av.Argentina, 123",true]),(["C/lorenzo, 3",false]),(["Av.Gimenez Losantos, 40",true]),]);

function Optimizar(tipo, elemento, resultadoCorrecto) {
